<form class="row g-3 needs-validation" novalidate="" wire:submit.prevent="{{$action}}">
    ...
    <div class="mb-3">
        <label class="form-label" for="validationTooltip01">Memasukkan nama kampus</label>
    ...
    <div class="mb-3">
        <label class="form-label" for="validationTooltip01">Memasukkan email kampus</label>
        <input class="form-control" id="validationTooltip01" type="email" wire:model.defer="user.email" required>
        <div class="invalid-tooltip">Bagian ini tidak boleh kosong</div>
    </div>

    <div class="mb-3">
        <label class="form-label" for="validationTooltip01">Memasukkan password kampus</label>
